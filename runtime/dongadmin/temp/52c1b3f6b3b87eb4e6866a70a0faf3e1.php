<?php /*a:5:{s:77:"E:\phpstudy\phpstudy_pro\WWW\www.qing.com\app\dongadmin\view\flink\index.html";i:1586157934;s:77:"E:\phpstudy\phpstudy_pro\WWW\www.qing.com\app\dongadmin\view\public\meta.html";i:1574502318;s:77:"E:\phpstudy\phpstudy_pro\WWW\www.qing.com\app\dongadmin\view\public\left.html";i:1585273681;s:76:"E:\phpstudy\phpstudy_pro\WWW\www.qing.com\app\dongadmin\view\public\top.html";i:1585963081;s:77:"E:\phpstudy\phpstudy_pro\WWW\www.qing.com\app\dongadmin\view\public\foot.html";i:1585986026;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="right_content_main">
                <div class="right_content_main_box padding_20">
                        <span class="layui-breadcrumb">
                            ...
                            <p><a class="layui-btn mar_t_15" href="<?php echo url('flink/add'); ?>">+添加</a></p>
                            <div class="mar_t_15">
                                <table class="layui-table ">
                                    ...
                                    <tbody>
                                            <?php if(is_array($flinkData) || $flinkData instanceof \think\Collection || $flinkData instanceof \think\Paginator): $i = 0; $__LIST__ = $flinkData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                        <tr>
                                        <td><?php echo htmlentities($vo['id']); ?></td>
                                        <td><?php echo htmlentities($vo['name']); ?></td>
                                        <td><?php echo htmlentities($vo['url']); ?></td>
                                        <td>
                                          <a href="<?php echo url('flink/edit',array('id'=>$vo['id'])); ?>" title="修改"><i class="layui-icon layui-icon-edit"></i></a>
                                          <a onClick="public_del('<?php echo url('base/del', ['id'=>$vo['id'],'m'=>'flink']); ?>')" href="javascript:;"  title="删除"><i class="layui-icon layui-icon-delete"></i></a>
                                        </td>
                                      </tr>
